import type { TR471Config, TR471Response } from '../../types/tr471';

const mockTR471Config: TR471Response = {
  TR471: {
...
export const getTR471MockConfig = (): TR471Response => mockTR471Config;

export const runTR471MockTest = (config: Partial<TR471Config>): TR471Response => {
  return {
    TR471: {
