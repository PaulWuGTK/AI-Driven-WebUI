    ...
    'Border Router': {
      ...
      MLE: {
        ...
        Dataset: {
          ...
          'Hex-encoded':
            '0e08000000000001000000030000104a0300001335060004001fffe0020867f20416ec6613210708fddce818f6018e09051080dd708d25f4f8ed06285a11054a708c030f4f70656e5468726561642d3065306501020e0e041073cbad3301792b5b16e277d2a96b45730c0402a0f7f8'
        },
        LeaderData: {
          DataVersion: 132,
          LeaderRouterID: 41,
...
export const getThreadStatusMockData = (): ThreadStatusResponse => mockThreadStatus;

export const getThreadScanMockData = (): ThreadScanResponse => mockThreadScan;

export const getThreadConfigurationMockData = (): ThreadConfigurationResponse =>
  mockThreadConfiguration;

export const updateThreadConfigurationMockData = (
  _data: ThreadConfigurationUpdateRequest
): ThreadConfigurationResponse => mockThreadConfiguration;

export const joinThreadNetworkMockData = (_data: ThreadJoinNetworkRequest): ThreadJoinNetworkResponse => {
  return {
    ThreadJoinNetwork: {
      Status: 'Join Success'
    }
...
export const getThreadCommissionerMockData = (): ThreadCommissionerResponse =>
  mockThreadCommissioner;

export const updateThreadCommissionerMockData = (
  data: ThreadCommissionerUpdateRequest
): ThreadCommissionerResponse => {
  if (data.ThreadCommissioner.Operation === 'Add') {
    ...
    mockThreadCommissioner.ThreadCommissioner.Joiners =
      mockThreadCommissioner.ThreadCommissioner.Joiners.filter(
...
export const getThreadTopologyMockData = (): ThreadTopologyResponse => mockThreadTopology;
