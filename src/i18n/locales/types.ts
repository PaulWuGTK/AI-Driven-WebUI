...
export interface Translations {
  ...
  matter: {
    ...
    pairingTitle: string;
    onoffTitle: string;
    multiadminTitle: string;
    subscribeTitle: string;
    getstatusTitle: string;
    bindingTitle: string;
    mediacontrolTitle: string;
    eevsecontrolTitle: string;
    whatIsMatter: string;
    matterDescription1: string;
    matterDescription2: string;
    whatIsMatterController: string;
    ...
    openCommissioningWindow: string;
    minInterval: string;
    maxInterval: string;
    subscribe: string;
    clearStatus: string;
    subscribeStatus: string;
    nodesManagement: string;
    refreshStatus: string;
    deleteStorageNode: string;
    provisionedNodes: string;
    writeAcl: string;
    lightNodeAlias: string;
    lightNodeId: string;
    switchNodeAlias: string;
    switchNodeId: string;
    aclEndpointId: string;
    writeBinding: string;
    lightEndpointId: string;
    switchEndpointId: string;
    nodeSelection: string;
    mediaAppLaunch: string;
    launchApp: string;
    stopApp: string;
    mediaControl: string;
    play: string;
    ...
    mediaReports: string;
    eevseEventTrigger: string;
    key: string;
    startTriggerEvent: string;
    clearTriggerEvent: string;
    triggerPluggedIn: string;
    clearPluggedIn: string;
    triggerChargingDemand: string;
    clearChargingDemand: string;
    eevseChargingEnable: string;
    minimumChargeCurrent: string;
    maximumChargeCurrent: string;
    enableCharging: string;
    eevseWrite: string;
    userMaximumChargeCurrent: string;
    writeUserMaximumChargeCurrent: string;
    eevseDisable: string;
    disableCharging: string;
    eevseStatus: string;
    state: string;
    supplyState: string;
    faultState: string;
    ...
    copied: string;
    stepScanQR: string;
    stepConfigureDevice: string;
    stepStartPairing: string;
    stepScanTitle: string;
    stepConfigureTitle: string;
    stepPairingTitle: string;
    scannedQRCode: string;
    selectDeviceType: string;
    deviceInformation: string;
    deviceAlias: string;
    deviceAliasPlaceholder: string;
    deviceAliasValidation: string;
    deviceAliasHint: string;
    backToScan: string;
    nextConfigureConnection: string;
    deviceSummary: string;
    connectionConfiguration: string;
    wifiConnection: string;
    threadNetwork: string;
    wifiNetworkSSID: string;
    wifiNetworkPlaceholder: string;
    wifiPasswordPlaceholder: string;
    threadDataset: string;
    threadDatasetPlaceholder: string;
    gettingDataset: string;
    back: string;
    pairing: string;
    startPairing: string;
    configureThisDevice: string;
    pairingSuccessful: string;
    pairingFailed: string;
    pairingError: string;
    getDatasetFailed: string;
    getDatasetError: string;
    smartLight: string;
    smartSwitch: string;
    sensor: string;
    smartOutlet: string;
