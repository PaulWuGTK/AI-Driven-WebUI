...
const translations = {
  ...
  wireless: {
    ...
    mloModeDisabledWithGroups: 'MLO がグループ {groups} で有効です – モードは変更できません。',
    ...
    securityNone6GWarning: 'いずれかの AP のセキュリティモードが None に設定されている場合、6GHz AP は無効になります。',
  ...
  guest: {
    ...
    dnsServersTooMany: 'DNS サーバーが多すぎます。最大 4 つまで設定できます。',
    beginAddress: '開始アドレス',
    endAddress: '終了アドレス',
    leaseTime: 'リース時間',
    seconds: '秒',
  ...
  remoteSyslog: {
    title: 'リモート Syslog 設定',
    description: 'システムメッセージ、WiFi、hostapdからのデバイスログを受信するリモート syslog サーバーを設定します',
    systemMessages: 'システムメッセージ',
    systemMessagesDesc: '一般的なシステムログ (/var/log/messages)',
    wifiLogs: 'WiFi ログ',
    wifiLogsDesc: 'WiFi 関連ログ (/var/log/messages_wifi)',
    hostapdLogs: 'Hostapd ログ',
    hostapdLogsDesc: 'Hostapd デーモンログ (/var/log/hostapd)',
    enableRemoteLogging: 'リモートログを有効化',
    serverAddress: 'サーバーアドレス',
    serverAddressPlaceholder: 'IPアドレスまたはホスト名',
    port: 'ポート',
    portPlaceholder: '514',
    protocol: 'プロトコル',
    status: '状態',
    ...
    statusEnabled: '有効',
    statusError: 'エラー',
    invalidIpAddress: '無効なIPアドレスまたはホスト名',
    invalidPort: 'ポートは 1 から 65535 の間である必要があります',
    addressRequired: '有効化時はサーバーアドレスが必要です',
    validationFailed: '送信前に検証エラーを修正してください',
  ...
  basicWan: {
    title: '基本 WAN 設定',
    interfaceManagement: 'WAN インターフェース管理',
    addInterface: 'インターフェース追加',
    editInterface: 'インターフェース編集',
    interface: 'インターフェース',
    ipv4Mode: 'IPv4 モード',
    ipv6Mode: 'IPv6 モード',
    vlanType: 'VLAN タイプ',
    ...
    actions: '操作',
    commonSettings: '共通設定',
    vlanPriority: 'VLAN 優先度',
    ipv4Settings: 'IPv4 設定',
    ipv4Enable: 'IPv4 有効',
    hostName: 'ホスト名',
    option60: 'DHCP オプション 60',
    vendorClassId: 'ベンダークラス ID',
    option61: 'DHCP オプション 61',
    clientId: 'クライアント ID',
    option12: 'DHCP オプション 12',
    userName: 'ユーザー名',
    password: 'パスワード',
    serviceName: 'サービス名',
    connectionTrigger: '接続トリガー',
    ...
    defaultRouter: 'デフォルトルーター',
    dnsServers: 'DNS サーバー',
    ipv6Settings: 'IPv6 設定',
    ipv6Enable: 'IPv6 有効',
    slaac: 'SLAAC',
    iana: 'IANA',
    iapd: 'IAPD',
    pppv6SharesCredentials: 'PPPoEv6 は IPv4 PPPoE 設定と同じユーザー名とパスワードを使用します。',
    ipv6Address: 'IPv6 アドレス',
    prefixLength: 'プレフィックス長',
    ipv6DefaultRouter: 'IPv6 デフォルトルーター',
