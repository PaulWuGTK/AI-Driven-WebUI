...
const translations = {
  ...
  remoteSyslog: {
    title: 'リモートログ',
    sectionTitle: 'リモートログ宛先',
    description: 'デバイスログを受信するリモート syslog サーバーを設定します。各ログタイプは異なる宛先に転送できます。',
    addDestination: '宛先を追加',
    editDestination: '宛先を編集',
    enable: '有効',
    logType: 'ログタイプ',
    address: 'サーバーアドレス',
    port: 'ポート',
    ...
    errors: {
      typeRequired: 'ログタイプを選択してください',
      addressRequired: 'サーバーアドレスを入力してください',
      invalidIp: '無効なIPアドレスです',
      invalidPort: 'ポートは 1 から 65535 の間である必要があります',
      typeDuplicate: 'このログタイプにはすでにリモート宛先が設定されています',
      destinationDuplicate: '宛先 {destination} はすでに {type} で使用されています。syslog-ng の persist-name 競合を避けるため、異なる IP:ポート の組み合わせを使用してください。',
      loadFailed: '設定の読み込みに失敗しました',
      saveFailed: '設定の保存に失敗しました',
      deleteFailed: '設定の削除に失敗しました'
    },
    confirmDelete: '{type} のリモート宛先を削除してもよろしいですか？',
    updateSuccess: '設定が正常に更新されました',
    deleteSuccess: '{type} のリモート宛先を削除しました'
  },
  operationMode: {
    title: '動作モード管理',
    mode: 'モード',
