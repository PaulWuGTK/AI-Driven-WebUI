...
const translations = {
  menu: {
    ...
    language: 'Langue',
    ntp: 'NTP',
    remoteSyslog: 'Journalisation distante',
    tr069: 'TR-069',
    tr369: 'TR-369',
  ...
  wlan: {
    ...
    auto: '(auto)',
    enable: 'Activer',
    matchLogic: 'Logique de correspondance',
  ...
  wireless: {
    ...
    mloModeDisabledWithGroups: 'MLO est activé sur les groupes: {groups} – le mode ne peut pas être modifié.',
    ...
    clientIsolation: 'Isolation des clients',
  ...
  guest: {
    ...
    dnsServersTooMany: 'Trop de serveurs DNS. Maximum 4 serveurs DNS autorisés.',
  ...
  wanManagement: {
    ...
    connectionTrigger: 'Déclencheur de connexion',
  ...
  lanBasic: {
    ...
    ipv4Protocol: 'Protocole IPv4',
    protocolDhcp: 'DHCP',
    protocolStatic: 'Statique',
    protocolAutoConfigured: 'Configuration automatique',
    protocolDhcpv6: 'DHCPv6',
    ipAddress: 'Adresse IP',
    ipv4Address: 'Adresse IPv4',
    subnetMask: 'Masque de sous-réseau',
    ipv6Enable: 'Activer IPv6',
    ulaEnable: 'Activer ULA',
    ipv6Protocol: 'Protocole IPv6',
    ipv6Address: 'Adresse IPv6',
    ipv6Prefix: 'Préfixe IPv6',
    ...
    apply: 'Appliquer',
    cancel: 'Annuler',
    applySuccess: 'Application r?ussie',
    applyingDhcpAcl: 'Application des param?tres DHCP ACL...',
    fetchDhcpAclFailed: '?chec de la r?cup?ration des param?tres DHCP ACL',
    updateDhcpAclFailed: '?chec de la mise ? jour des param?tres DHCP ACL',
  ...
  dmz: {
    ...
    selectDevice: 'Sélectionner un appareil connecté',
  ...
  remoteSyslog: {
    title: 'Journalisation distante',
    sectionTitle: 'Destinations de journalisation distante',
    description: 'Configurer les serveurs syslog distants pour recevoir les journaux de l\'appareil. Chaque type de journal peut être transféré vers une destination différente.',
    ...
    protocol: 'Protocole',
    status: 'État',
    selectType: 'Sélectionner le type de journal',
    typeConfigured: '(Configuré)',
    enableRemoteLogging: 'Activer la journalisation distante',
    errors: {
      typeRequired: 'Le type de journal est requis',
      addressRequired: 'L\'adresse du serveur est requise',
      invalidIp: 'Adresse IP non valide',
      invalidPort: 'Le port doit être compris entre 1 et 65535',
      typeDuplicate: 'Ce type de journal a déjà une destination distante configurée',
      destinationDuplicate: 'La destination {destination} est déjà utilisée par {type}. Veuillez utiliser une combinaison IP:Port différente pour éviter les conflits de persist-name syslog-ng.',
    ...
    confirmDelete: 'Êtes-vous sûr de vouloir supprimer la destination distante pour {type} ?',
    updateSuccess: 'Configuration mise à jour avec succès',
    deleteSuccess: 'Destination distante {type} supprimée avec succès'
  },
  operationMode: {
  ...
  device: {
    ...
    backupProfile: 'Profil de secours',
    ...
    sendBootstrap: 'Envoyer Bootstrap au serveur ACS',
    logCount: 'Nombre',
    logMaxEntries: 'Entrées max',
    logServerTime: 'Heure serveur',
    logTimestamp: 'Horodatage',
    logEventType: 'Type d\'événement',
    logDetail: 'Détail',
    alias: 'Alias',
  ...
  wizard: {
    ...
    statusFailed: 'Échoué',
    onboardingFailedTitle: 'Configuration échouée',
    onboardingStartFailed: 'Impossible de démarrer la configuration. Veuillez réessayer.',
    onboardingFailed: 'L\'intégration a échoué. Veuillez vérifier la connexion et réessayer.',
    ethernetConnectionFailed: 'La connexion Ethernet a échoué. Veuillez vérifier le câble et réessayer.',
    onboardingTimeout: 'La configuration a expiré. Veuillez vérifier la connexion et réessayer.',
    backToSetup: 'Retour à la configuration',
    applyingTitle: 'Application des paramètres...',
    applyingMessage: 'Nous appliquons vos paramètres.',
    ...
    passwordPlaceholderWifi: '8–63 caractères, lettres et chiffres',
    passwordHelpText: 'Utilisez 8 à 63 caractères en combinant lettres et chiffres.',
  ...
  basicWan: {
    title: 'Configuration WAN de base',
    interfaceManagement: 'Gestion des interfaces WAN',
    addInterface: 'Ajouter une interface',
    ...
    vlanPriority: 'Priorité VLAN',
    ipv4Settings: 'Paramètres IPv4',
    ipv4Enable: 'Activer IPv4',
    hostName: 'Nom d\'hôte',
    option60: 'DHCP Option 60',
    vendorClassId: 'ID de classe fournisseur',
    option61: 'DHCP Option 61',
    clientId: 'ID client',
    option12: 'DHCP Option 12',
    userName: 'Nom d\'utilisateur',
    password: 'Mot de passe',
    serviceName: 'Nom du service',
    connectionTrigger: 'Déclencheur de connexion',
    ...
    iana: 'IANA',
    iapd: 'IAPD',
    pppv6SharesCredentials: 'PPPoEv6 utilise les mêmes identifiants que les paramètres PPPoE IPv4.',
    ipv6Address: 'Adresse IPv6',
    prefixLength: 'Longueur du préfixe',
    ipv6DefaultRouter: 'Routeur IPv6 par défaut',
    ...
    duplicatePppoe: 'Une seule interface PPPoE est autorisée. {iface} utilise déjà PPPoE.'
  },
  ipFiltering: {
