...
const translations = {
  ...
  remoteSyslog: {
    title: 'Configuration Syslog distant',
    description: 'Configurer les serveurs syslog distants pour recevoir les journaux de l\'appareil des messages système, WiFi et hostapd',
    systemMessages: 'Messages système',
    systemMessagesDesc: 'Journaux système généraux (/var/log/messages)',
    wifiLogs: 'Journaux WiFi',
    wifiLogsDesc: 'Journaux liés au WiFi (/var/log/messages_wifi)',
    hostapdLogs: 'Journaux Hostapd',
    hostapdLogsDesc: 'Journaux du démon Hostapd (/var/log/hostapd)',
    enableRemoteLogging: 'Activer la journalisation distante',
    serverAddress: 'Adresse du serveur',
    serverAddressPlaceholder: 'Adresse IP ou nom d\'hôte',
    port: 'Port',
    portPlaceholder: '514',
    protocol: 'Protocole',
    status: 'État',
    ...
    statusError: 'Erreur',
    invalidIpAddress: 'Adresse IP ou nom d\'hôte non valide',
    invalidPort: 'Le port doit être compris entre 1 et 65535',
    addressRequired: 'L\'adresse du serveur est requise lorsqu\'elle est activée',
    validationFailed: 'Veuillez corriger les erreurs de validation avant de soumettre',
    updateSuccess: 'Configuration mise à jour avec succès',
    updateFailed: 'Échec de la mise à jour de la configuration',
