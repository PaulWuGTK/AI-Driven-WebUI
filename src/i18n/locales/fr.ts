...
export default {
  ...
  matter: {
    title: 'Matter',
    description: 'Matter est une nouvelle norme pour la maison intelligente visant à simplifier le développement pour les fabricants et à améliorer la compatibilité pour les consommateurs.',
    pairingTitle: 'Appairage',
    onoffTitle: 'OnOff',
    multiadminTitle: 'MultiAdmin',
    subscribeTitle: 'S’abonner',
    getstatusTitle: 'Obtenir le statut',
    bindingTitle: 'Liaison',
    mediacontrolTitle: 'Contrôle média',
    eevsecontrolTitle: 'Contrôle EEVSE',
    whatIsMatter: 'Qu’est-ce que Matter ?',
    matterDescription1: 'Matter (anciennement Project CHIP) est une couche d’application open source visant à créer une norme de communication unifiée entre les appareils domotiques, les applications mobiles et les services cloud. Il prend en charge des technologies telles que le Wi-Fi, Thread, Bluetooth® LE, et utilise IPv6 (TCP, UDP) pour relier les différents réseaux.',
    matterDescription2: 'Le but de Matter est de simplifier le développement pour les fabricants et de renforcer la compatibilité pour les utilisateurs. Le projet repose sur l’idée que les objets connectés doivent être sécurisés, fiables et faciles à utiliser. En se basant sur IP, il définit des technologies réseau pour la certification des appareils.',
    whatIsMatterController: 'Qu’est-ce qu’un contrôleur Matter ?',
    controllerDescription: 'Le contrôleur Matter est un appareil utilisé pour appairer et gérer les accessoires Matter via Bluetooth LE et IPv6 à distance.',
    nodeAlias: 'Alias du nœud',
    nodeId: 'ID du nœud',
    endpointId: 'ID du point de terminaison',
    processing: 'Traitement en cours...',
    result: 'Résultat :',
    pairingType: 'Veuillez choisir le type d’appairage :',
    onnetwork: 'RÉSEAU LOCAL',
    bleWifi: 'BLE-WIFI',
    ...
    getDataset: 'OBTENIR-DONNÉES',
    on: 'ACTIVER',
    off: 'DÉSACTIVER',
    toggle: 'BASCULER',
    read: 'LIRE',
    getReport: 'Obtenir un rapport',
    windowTimeout: 'Délai de la fenêtre',
    openCommissioningWindow: 'Ouvrir la fenêtre de commission avec BCM',
    minInterval: 'Intervalle min',
    maxInterval: 'Intervalle max',
    subscribe: 'S’abonner',
    clearStatus: 'Effacer le statut',
    subscribeStatus: 'S’abonner au statut',
    nodesManagement: 'Gestion des nœuds',
    refreshStatus: 'Actualiser le statut',
    deleteStorageNode: 'Supprimer le nœud de stockage',
    provisionedNodes: 'Nœuds provisionnés',
    writeAcl: 'Écrire ACL',
    lightNodeAlias: 'Alias du nœud lumière',
    lightNodeId: 'ID du nœud lumière',
    switchNodeAlias: 'Alias du nœud interrupteur',
    switchNodeId: 'ID du nœud interrupteur',
    aclEndpointId: 'ID de point de terminaison ACL',
    writeBinding: 'Écrire la liaison',
    lightEndpointId: 'ID point de terminaison lumière',
    switchEndpointId: 'ID point de terminaison interrupteur',
    nodeSelection: 'Sélection de nœud',
    mediaAppLaunch: 'Lancement d’application média',
    launchApp: 'Lancer APP',
    stopApp: 'Arrêter APP',
    mediaControl: 'Contrôle Média',
    play: 'Lecture',
    pause: 'Pause',
    stop: 'Stop',
    previous: 'Précédent',
    ...
    rewind: 'Rembobiner',
    fastForward: 'Avancer rapide',
    mediaStatus: 'Statut média',
    currentState: 'État actuel',
    startTime: 'Heure de début',
    duration: 'Durée',
    playbackSpeed: 'Vitesse de lecture',
    mediaReports: 'Rapports média',
    eevseEventTrigger: 'Déclencheur EEVSE',
    key: 'Clé',
    startTriggerEvent: 'Déclencher événement',
    clearTriggerEvent: 'Effacer événement',
    triggerPluggedIn: 'Déclencher branchement',
    clearPluggedIn: 'Effacer branchement',
    triggerChargingDemand: 'Déclencher demande de charge',
    clearChargingDemand: 'Effacer demande de charge',
    eevseChargingEnable: 'Activer charge EEVSE',
    minimumChargeCurrent: 'Courant min de charge',
    maximumChargeCurrent: 'Courant max de charge',
    enableCharging: 'Activer la charge',
    eevseWrite: 'Écriture EEVSE',
    userMaximumChargeCurrent: 'Courant max utilisateur',
    writeUserMaximumChargeCurrent: 'Écrire courant max utilisateur',
    eevseDisable: 'Désactiver EEVSE',
    disableCharging: 'Désactiver la charge',
    eevseStatus: 'Statut EEVSE',
    state: 'État',
    supplyState: 'État d’alimentation',
    faultState: 'État de défaut',
    ...
    stepScanQR: 'Scanner le code QR',
    stepConfigureDevice: 'Configurer l\'appareil',
    stepStartPairing: 'Démarrer l\'appairage',
    stepScanTitle: 'Étape 1 : Scanner le code QR de l\'appareil',
    stepConfigureTitle: 'Étape 2 : Configurer l\'appareil',
    stepPairingTitle: 'Étape 3 : Démarrer l\'appairage',
    ...
    deviceAlias: 'Alias de l\'appareil',
    deviceAliasPlaceholder: 'Entrez un nom convivial pour cet appareil',
    deviceAliasValidation: 'L\'alias de l\'appareil ne peut contenir que des lettres, des chiffres et des traits de soulignement',
    deviceAliasHint: 'Seuls les lettres, chiffres et traits de soulignement sont autorisés',
    backToScan: 'Retour au scan',
    nextConfigureConnection: 'Suivant : Configurer la connexion',
    deviceSummary: 'Résumé de l\'appareil',
    connectionConfiguration: 'Configuration de connexion',
    wifiConnection: 'Connexion WiFi',
    threadNetwork: 'Réseau Thread',
    wifiNetworkSSID: 'Réseau WiFi (SSID)',
    wifiNetworkPlaceholder: 'Entrez le nom du réseau WiFi',
    wifiPasswordPlaceholder: 'Entrez le mot de passe WiFi',
    threadDataset: 'Dataset Thread',
    threadDatasetPlaceholder: 'Entrez le dataset Thread ou cliquez sur Obtenir Dataset',
    gettingDataset: 'Obtention...',
    back: 'Retour',
    pairing: 'Appairage...',
    startPairing: 'Démarrer l\'appairage',
    configureThisDevice: 'Configurer cet appareil',
    pairingSuccessful: 'Appareil "{alias}" appairé avec succès !',
    pairingFailed: 'Échec de l\'appairage',
    pairingError: 'Une erreur s\'est produite lors de l\'appairage',
    getDatasetFailed: 'Échec de l\'obtention du dataset Thread',
    getDatasetError: 'Format de réponse inattendu lors de l\'obtention du dataset Thread',
    smartLight: 'Éclairage intelligent',
    smartSwitch: 'Interrupteur intelligent',
    sensor: 'Capteur',
    smartOutlet: 'Prise intelligente',
