...
export default {
  ...
  wizard: {
    ...
    smartConnectTooltip: 'Combiner toutes les bandes sous un seul nom de réseau',
    mloNetwork: 'Réseau MLO',
    mloTooltip: 'Multi-Link Operation pour des vitesses plus élevées',
    psc: 'PSC',
    pscTooltip: 'Canaux de balayage préférés pour la bande 6 GHz',
    pmf: 'PMF',
    pmfTooltip: 'Protected Management Frames pour une sécurité renforcée',
