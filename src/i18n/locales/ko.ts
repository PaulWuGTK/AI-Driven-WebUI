...
const translations = {
  ...
  remoteSyslog: {
    title: '원격 로깅',
    sectionTitle: '원격 로깅 대상',
    description: '장치 로그를 수신하도록 원격 syslog 서버를 구성합니다. 각 로그 유형은 다른 대상으로 전달할 수 있습니다.',
    addDestination: '대상 추가',
    editDestination: '대상 편집',
    enable: '활성화',
    logType: '로그 유형',
    address: '서버 주소',
    port: '포트',
    ...
    selectType: '로그 유형 선택',
    typeConfigured: '(구성됨)',
    enableRemoteLogging: '원격 로깅 활성화',
    errors: {
      typeRequired: '로그 유형을 선택해야 합니다',
      addressRequired: '서버 주소를 입력해야 합니다',
      invalidIp: '잘못된 IP 주소입니다',
      invalidPort: '포트는 1에서 65535 사이여야 합니다',
      typeDuplicate: '이 로그 유형에는 이미 원격 대상이 구성되어 있습니다',
      destinationDuplicate: '대상 {destination}은(는) 이미 {type}에서 사용 중입니다. syslog-ng persist-name 충돌을 방지하려면 다른 IP:포트 조합을 사용하십시오.',
      loadFailed: '구성 로드에 실패했습니다',
      saveFailed: '구성 저장에 실패했습니다',
      deleteFailed: '구성 삭제에 실패했습니다'
    },
    confirmDelete: '{type}의 원격 대상을 삭제하시겠습니까?',
    updateSuccess: '구성이 성공적으로 업데이트되었습니다',
    deleteSuccess: '{type} 원격 대상이 성공적으로 삭제되었습니다'
  },
  operationMode: {
    title: '동작 모드 관리',
    mode: '모드',
