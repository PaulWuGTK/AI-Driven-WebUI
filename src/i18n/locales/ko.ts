...
export default {
  ...
  wizard: {
    ...
    smartConnectTooltip: '모든 밴드를 하나의 네트워크 이름으로 통합합니다',
    mloNetwork: 'MLO 네트워크',
    mloTooltip: '더 빠른 속도를 위한 Multi-Link Operation',
    psc: 'PSC',
    pscTooltip: '6GHz 대역용 우선 스캐닝 채널',
    pmf: 'PMF',
    pmfTooltip: '보안을 강화하는 Protected Management Frames',
