...
const translations = {
  ...
  remoteSyslog: {
    title: '원격 Syslog 구성',
    description: '시스템 메시지, WiFi 및 hostapd의 장치 로그를 수신하도록 원격 syslog 서버를 구성합니다',
    systemMessages: '시스템 메시지',
    systemMessagesDesc: '일반 시스템 로그 (/var/log/messages)',
    wifiLogs: 'WiFi 로그',
    wifiLogsDesc: 'WiFi 관련 로그 (/var/log/messages_wifi)',
    hostapdLogs: 'Hostapd 로그',
    hostapdLogsDesc: 'Hostapd 데몬 로그 (/var/log/hostapd)',
    enableRemoteLogging: '원격 로깅 활성화',
    serverAddress: '서버 주소',
    serverAddressPlaceholder: 'IP 주소 또는 호스트명',
    port: '포트',
    portPlaceholder: '514',
    protocol: '프로토콜',
    status: '상태',
    ...
    statusEnabled: '활성화됨',
    statusError: '오류',
    invalidIpAddress: '잘못된 IP 주소 또는 호스트명',
    invalidPort: '포트는 1에서 65535 사이여야 합니다',
    addressRequired: '활성화 시 서버 주소가 필요합니다',
    validationFailed: '제출하기 전에 유효성 검사 오류를 수정하십시오',
    updateSuccess: '구성이 성공적으로 업데이트되었습니다',
    updateFailed: '구성 업데이트에 실패했습니다',
