...
const translations = {
  ...
  wanCht: {
    ...
    ipv4Gateway: 'IPv4 网关',
    subnetMask: '子网掩码',
    ipv4PrimaryDNS: 'IPv4 首选 DNS 服务器',
    ipv4SecondaryDNS: 'IPv4 备用 DNS 服务器',
    macAddress: 'MAC 地址',
    ipv6Address: 'IPv6 地址',
    ipv6Gateway: 'IPv6 网关',
    ipv6Prefix: 'IPv6 前缀',
    ipv6PrimaryDNS: 'IPv6 首选 DNS 服务器',
    ipv6SecondaryDNS: 'IPv6 备用 DNS 服务器',
    ipv4ConnectionStatus: 'IPv4 连接状态',
    connectionType: '连接类型',
    ipAddress: 'IP 地址',
    gateway: '网关',
    primaryDNS: '首选 DNS',
  ...
  lcm: {
    ...
    cpuPercent: 'CPU 占用率 (%)',
    cpuHint: '范围：1–100，默认：100',
    memorySize: '内存大小',
    memHint: '范围：1–{max} MiB，默认：1',
    diskSpace: '磁盘空间',
    diskHint: '范围：1–{max} MiB，默认：1',
    nameRequired: '名称为必填项',
    nameExists: '名称已存在',
    cpuRange: 'CPU 必须在 1 到 100 之间',
    memRange: '内存必须在 1 到 {max} 之间',
    diskRange: '磁盘必须在 1 到 {max} 之间',
    confirmDelete: '确定要删除此执行环境吗？',
    confirmDeleteDeployment: '确定要删除此部署单元吗？',
    deploymentUnit: '部署单元',
    addDU: '新增 DU',
    updateDU: '更新 DU',
    description: '描述',
    installedEE: '已安装的执行环境',
    appRegistry: '应用注册库',
    urlRequired: 'URL 为必填项',
    urlFormatError: 'URL 必须以 docker:// 开头',
    urlPlaceholder: 'docker://<server>/<app>:<tag>',
    uuidRequired: 'UUID 为必填项',
    uuidFormatError: 'UUID 格式无效（xxxxxxxx-xxxx-5xxx-Nxxx-xxxxxxxxxxxx）',
    uuidPlaceholder: 'xxxxxxxx-xxxx-5xxx-Nxxx-xxxxxxxxxxxx',
    username: '用户名',
    usernameRequired: '用户名为必填项',
    password: '密码',
    passwordRequired: '密码为必填项',
    eeToInstalled: '待安装的执行环境',
    installedEERequired: '“待安装的执行环境”为必填项',
    runtimeConfiguration: '运行时配置',
    privileged: '特权模式',
    network: '网络',
    shareParentNetwork: '共享父网络',
    portForwarding: '端口转发',
    portForwardingRules: '端口转发规则',
    interface: '接口',
    protocol: '协议',
    externalPort: '外部端口',
    internalPort: '内部端口',
  ...
  wireless: {
    ...
    mloModeDisabledWithGroups: 'MLO 已在群组 {groups} 启用，无法更改模式。',
    ...
    mloSecurityNoneHint: '注意：当安全模式设置为「None」时，MLO 不可用。',
    mloMeshWarning: '一个或多个 AP（主用或访客）已启用 MLO。应用 Mesh 设置时将自动禁用 MLO。',
    securityNone6GWarning: '当任何 AP 的安全模式设置为 None 时，6GHz AP 将被禁用。',
  ...
  guest: {
    ...
    dnsServer: 'DNS 服务器',
    dnsServers: 'DNS 服务器',
    dnsServersHint: '多个 DNS 服务器请以逗号分隔，例如 192.168.1.1, 8.8.8.8（最多 4 个）',
    dnsServersInvalid: 'DNS 服务器地址无效，请输入以逗号分隔的有效 IPv4 地址。',
    dnsServersTooMany: 'DNS 服务器数量过多，最多允许 4 个 DNS 服务器。',
    beginAddress: '起始地址',
    endAddress: '结束地址',
    leaseTime: '租约时间',
    seconds: '秒',
    hostName: '主机名称',
    macAddress: 'MAC 地址',
    applyingSettings: '正在应用访客 Wi-Fi 设置…'
  },
  macfilter: {
    title: '无线 MAC 过滤',
    ssid: 'SSID',
  ...
  remoteSyslog: {
    title: '远程 Syslog 配置',
    description: '配置远程 syslog 服务器以接收来自系统消息、WiFi 和 hostapd 的设备日志',
    systemMessages: '系统消息',
    systemMessagesDesc: '常规系统日志 (/var/log/messages)',
    wifiLogs: 'WiFi 日志',
    wifiLogsDesc: 'WiFi 相关日志 (/var/log/messages_wifi)',
    hostapdLogs: 'Hostapd 日志',
    hostapdLogsDesc: 'Hostapd 守护进程日志 (/var/log/hostapd)',
    enableRemoteLogging: '启用远程日志',
    serverAddress: '服务器地址',
    serverAddressPlaceholder: 'IP 地址或主机名',
    port: '端口',
    portPlaceholder: '514',
    protocol: '协议',
    status: '状态',
    ...
    statusEnabled: '已启用',
    statusError: '错误',
    invalidIpAddress: '无效的 IP 地址或主机名',
    invalidPort: '端口必须在 1 到 65535 之间',
    addressRequired: '启用时必须输入服务器地址',
    validationFailed: '请修正验证错误后再提交',
  ...
  device: {
    ...
    sendBootstrap: '向 ACS 服务器发送 Bootstrap',
    logCount: '条数',
    logMaxEntries: '最大条数',
    logServerTime: '服务器时间',
    logTimestamp: '时间戳',
  ...
  tr471: {
    title: 'TR-471 速度测试',
    connection_server: '服务器',
    connection_port: '端口',
    connection_mtu: 'MTU',
    connection_dscp: 'DSCP',
    connection_protocolVersion: '协议版本',
    connection_networkInterface: '网络接口',
    connection_algorithm: '算法',
    connection_udpPayloadContent: 'UDP 载荷内容',
    connection_ethernetPriority: '以太网优先级',
    connection_authenticationEnabled: '启用认证',
    connection_authenticationCode: '认证代码',
    connection_interfaceRateIncluded: '包含本地接口速率',
    connection_jumboFramesPermitted: '允许 Jumbo 帧',
    connection_ipdvEnable: '启用 IPDV',
    advanced_toggleShow: '显示高级配置',
    advanced_toggleHide: '隐藏高级配置',
    advanced_maximumTestBandwidth: '最大测试带宽',
    advanced_startSendingRate: '起始发送速率',
    advanced_startSendingRateIndex: '起始发送速率索引',
    advanced_numberTestSubIntervals: '测试子区间数量',
    advanced_numberFirstModeTestSubIntervals: '第一模式测试子区间数量',
    advanced_testSubInterval: '测试子区间',
    advanced_statusFeedbackInterval: '状态反馈间隔',
    advanced_retryThresh: '重试阈值',
    advanced_testType: '测试类型',
    advanced_seqErrThresh: '序列错误阈值',
    advanced_reordDupIgnoreEnable: '启用重排序/重复忽略',
    advanced_lowerThresh: '下限阈值',
    advanced_upperThresh: '上限阈值',
    advanced_slowAdjThresh: '慢速调整阈值',
    advanced_highSpeedDelta: '高速变化量',
    advanced_flowCount: 'Flow 数量',
    advanced_maximumFlows: '最大 Flow 数量',
    test_sectionTitle: '速度测试类型',
    test_upload: '上传',
    test_download: '下载',
    test_run: '开始速度测试',
    test_running: '测试运行中…',
    test_canNotRun: '请至少选择一种测试类型',
    results_title: '结果汇总',
    results_uploadTitle: '上传结果',
    results_downloadTitle: '下载结果',
    results_label_ipLayerCapacity: 'IP 层容量',
    results_label_lossRatio: '丢包率',
    results_label_rttRange: 'RTT 范围',
    results_label_pdvRange: 'PDV 范围',
    results_chart_ipLayerCapacity: 'IP 层容量',
    results_chart_roundTripTime: '往返时延 (RTT)',
    results_chart_jitter: '抖动',
    results_chart_loss: '丢包',
    results_state_none: '无',
    results_state_requested: '已请求',
  ...
  wizard: {
    ...
    mloNetwork: 'MLO 网络',
    mloTooltip: 'Multi-Link Operation（MLO，多链路操作）使支持 Wi-Fi 7 的设备能够同时在 2.4 GHz、5 GHz 和 6 GHz 频段上连接，为 VR/AR、游戏、远程办公和云计算带来更高速度、更低时延和更高可靠性。',
    psc: 'PSC',
    ...
    statusSuccess: '成功',
    statusFailed: '失败',
    onboardingFailedTitle: '设置失败',
    onboardingStartFailed: '无法启动设置，请重试。',
    onboardingFailed: '入网失败，请检查连接后重试。',
    ethernetConnectionFailed: '以太网连接失败，请检查网线后重试。',
    onboardingTimeout: '设置超时，请检查连接后重试。',
    backToSetup: '返回设置',
    applyingTitle: '正在应用设置...',
    applyingMessage: '正在应用您的设置。',
    applyingWarning: '请稍候，设置应用中。',
    meshTitle: 'Smart Mesh',
    meshSubtitle: '创建 Smart Mesh 网络，在家中实现无缝 Wi-Fi 覆盖，并通过简单的集中管理进行维护。',
    meshEnforcesCommonSsid: '启用 Mesh 时，将强制启用 Common SSID。',
    ...
    acceptTermsCheckbox: '我已阅读并同意本软件的许可条款',
    ssid: 'SSID',
    ssidPlaceholder: '请输入网络名称',
    securityType: '安全类型',
    wpa3Warning: '6GHz 客户端仅支持使用 WPA3-Personal 认证',
    passwordLabel: '密码',
    passwordPlaceholderWifi: '8–63 个字符，字母和数字组合',
    passwordHelpText: '8–63 个字符，请使用字母与数字组合',
  ...
  mcl: {
    ...
    mgmtServices: '管理服务',
    trustDomain: '信任域',
    wanInterfacesForAccessingServices: '用于访问服务的 WAN 接口：',
    anyWan: '任一 WAN',
    multipleWans: '多个 WAN',
    service: '服务',
    lan: 'LAN',
    ...
    ipAddress: 'IP 地址',
    ipAddresses: 'IP 地址',
    addTrustDomain: '新增信任域',
    trustDomainPlaceholder: '例如：192.168.1.0/24',
    cidrHint: '格式：CIDR <IP Address>/<Prefix Length>',
    saveSuccess: 'MCL 设置保存成功',
    errorFetch: '无法获取 MCL 设置',
    errorSave: '无法保存 MCL 设置',
    errorSelectWanInterface: '在多个 WAN 模式下，请至少选择一个 WAN 接口',
    errorTrustDomainRequired: 'IP 地址为必填项',
    errorTrustDomainFormat: 'CIDR 格式无效，请使用 <IP Address>/<Prefix Length>',
    errorTrustDomainDuplicate: '该信任域已存在',
    addTrustDomainSuccess: '信任域添加成功',
    deleteTrustDomainSuccess: '信任域删除成功',
    confirmDeleteTrustDomainTitle: '删除信任域',
    confirmDeleteTrustDomainMessage: '确定要删除“{cidr}”吗？',
  },
  nat: {
    title: 'NAT 设置',
    portForwarding: '端口转发',
  ...
  basicWan: {
    ...
    commonSettings: '通用设置',
    vlanPriority: 'VLAN 优先级',
    ipv4Settings: 'IPv4 设置',
    ipv4Enable: '启用 IPv4',
    hostName: '主机名',
    option60: 'DHCP Option 60',
    vendorClassId: '厂商类别 ID',
    ...
    defaultRouter: '默认路由器',
    dnsServers: 'DNS 服务器',
    ipv6Settings: 'IPv6 设置',
    ipv6Enable: '启用 IPv6',
    slaac: 'SLAAC',
    iana: 'IANA',
    iapd: 'IAPD',
    pppv6SharesCredentials: 'PPPoEv6 使用与 IPv4 PPPoE 相同的用户名和密码设置。',
    ipv6Address: 'IPv6 地址',
    prefixLength: '前缀长度',
    ipv6DefaultRouter: 'IPv6 默认路由器',
  ...
  basicWanCht: {
    ...
    editDelete: '编辑 / 删除',
    enable: '启用',
    enableWarning: '勾选后会显示其他字段以供配置。',
    ipv4Protocol: 'IPv4 协议',
    protocolReadOnly: '此字段为只读。',
    username: '用户名',
    password: '密码',
    fieldNotEmpty: '此字段不能为空。',
    serviceName: '服务名称（可选）',
    connectionType: '连接类型',
    alwaysConnected: '始终连接',
    triggerByTraffic: '自动 - 按流量触发',
    connectTrigger: '连接触发条件',
    alwaysOn: 'AlwaysOn',
    onDemand: 'OnDemand',
    idleTime: '空闲时间',
    idleTimeModifiable: '当连接类型为“自动 - 按流量触发”时，此字段才可修改。',
    mtu: 'MTU（{min}~{max}）',
    ...
    primaryDNS: '主 DNS',
    secondaryDNS: '备 DNS',
    dnsManualModifiable: '当 DNS IP 地址为“手动”时，此字段才可修改。',
    natFunction: 'NAT 功能',
    igmpProxy: 'IGMP 代理',
    vlan: 'VLAN',
    priorityBit: '优先级位',
    ...
    atLeastOneWanModeRequired: '至少必须保留一个启用中的 WAN 模式',
    defaultGatewayConflict: 'PPPoE 与 IPoE 不能同时启用默认网关'
  },
  routing: {
    title: '路由',
    staticRoute: '静态路由',
    ...
    policyRoute: '策略路由',
    rip: 'RIP',
    staticRouteDescription: '您可以在 Zyxel 设备上查看和配置静态路由。当内网中的 LAN 主机需要将文件或数据传输到缓存，或者在家中或办公室有两个类似于 Internet 的公网需要互联时，可以通过路由来节省时间和带宽。',
    dnsRouteDescription: '配置 DNS 路由规则，根据域名模式控制 DNS 查询的转发方式。',
    addStaticRoute: '新增静态路由',
    editStaticRoute: '编辑静态路由',
    status: '状态',
    name: '名称',
    destinationIp: '目标 IP',
    subnetMaskPrefixLength: '子网掩码/前缀长度',
    gateway: '网关',
    interface: '接口',
    action: '操作',
    noStaticRoutes: '尚未配置任何静态路由',
    confirmDelete: '确定要删除此静态路由吗？',
    enable: '启用',
    routeName: '路由名称',
    ...
    subnetMask: '子网掩码',
    prefixLength: '前缀长度',
    useGatewayIpAddress: '使用网关 IP 地址',
    gatewayIpAddress: '网关 IP 地址',
    useInterface: '使用接口',
    note: '注意',
    gatewayIpNote: '网关 IP 地址必须位于所选接口的地址范围内。',
    routeNameRequired: '路由名称为必填项',
    destinationIpRequired: '目标 IP 地址为必填项',
    subnetMaskRequired: '子网掩码为必填项',
    invalidIPv4: '无效的 IPv4 地址格式',
    invalidIPv6: '无效的 IPv6 地址格式',
    invalidSubnetMask: '无效的子网掩码格式',
    invalidPrefixLength: '无效的前缀长度（必须在 0 到 128 之间）',
    gatewayIpRequired: '网关 IP 地址为必填项',
    invalidGatewayIPv4: '无效的网关 IPv4 地址',
    invalidGatewayIPv6: '无效的网关 IPv6 地址',
    reservedDestinationIp: '此 IP 地址为保留地址（如广播、环回、多播），无法作为目的地使用。',
