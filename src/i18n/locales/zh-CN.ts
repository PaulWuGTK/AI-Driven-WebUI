...
const translations = {
  ...
  remoteSyslog: {
    title: '远程日志',
    sectionTitle: '远程日志目的地',
    description: '配置远程 syslog 服务器以接收设备日志。每种日志类型可转发至不同目的地。',
    ...
    errors: {
      typeRequired: '必须选择日志类型',
      addressRequired: '必须输入服务器地址',
      invalidIp: 'IP 地址格式错误',
      invalidPort: '端口必须在 1 到 65535 之间',
      typeDuplicate: '此日志类型已配置远程目的地',
      destinationDuplicate: '目的地 {destination} 已被 {type} 使用。请使用不同的 IP:端口组合以避免 syslog-ng persist-name 冲突。',
      loadFailed: '加载配置失败',
      saveFailed: '保存配置失败',
      deleteFailed: '删除配置失败'
    },
    confirmDelete: '确定要删除 {type} 的远程目的地吗？',
    updateSuccess: '配置更新成功',
    deleteSuccess: '{type} 远程目的地删除成功'
  },
  operationMode: {
    title: '操作模式管理',
    mode: '模式',
