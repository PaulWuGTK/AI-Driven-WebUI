...
const translations = {
  ...
  remoteSyslog: {
    title: 'Remote Syslog Configuration',
    description: 'Configure remote syslog servers to receive device logs from system messages, WiFi, and hostapd',
    systemMessages: 'System Messages',
    systemMessagesDesc: 'General system logs (/var/log/messages)',
    wifiLogs: 'WiFi Logs',
    wifiLogsDesc: 'WiFi-related logs (/var/log/messages_wifi)',
    hostapdLogs: 'Hostapd Logs',
    hostapdLogsDesc: 'Hostapd daemon logs (/var/log/hostapd)',
    enableRemoteLogging: 'Enable Remote Logging',
    serverAddress: 'Server Address',
    serverAddressPlaceholder: 'IP address or hostname',
    port: 'Port',
    portPlaceholder: '514',
    protocol: 'Protocol',
    status: 'Status',
    ...
    statusError: 'Error',
    invalidIpAddress: 'Invalid IP address or hostname',
    invalidPort: 'Port must be between 1 and 65535',
    addressRequired: 'Server address is required when enabled',
