...
const translations: Translations = {
  ...
  matter: {
    ...
    getstatusTitle: 'GetStatus',
    bindingTitle: 'Binding',
    mediacontrolTitle: 'MediaControl',
    eevsecontrolTitle: 'EevseControl',
    whatIsMatter: 'What is Matter?',
    matterDescription1: 'Matter (formerly Project Connected Home over IP or Project CHIP) is an open-source application layer that aims at creating a unified communication standard across smart home devices, mobile applications, and cloud services. It supports a wide range of existing technologies, including Wi-Fi, Thread, and Bluetooth® LE, and uses IPv6-based transport protocols like TCP and UDP to ensure connectivity between different kinds of networks.',
    matterDescription2: 'The goal of the Matter project is to simplify development for manufacturers and increase compatibility for consumers. The project is built around a shared belief that smart home devices should be secure, reliable, and seamless to use. By building upon Internet Protocol (IP), the project aims to enable communication across smart home devices, mobile apps, and cloud services and to define a specific set of IP-based networking technologies for device certification.',
    whatIsMatterController: 'What is Matter Controller?',
    controllerDescription: 'The Matter controller is a role within the Matter development environment. The controller device is used to pair and control the Matter accessory device remotely over a network, interacting with it using Bluetooth LE and the regular IPv6 communication.',
    nodeAlias: 'Node Alias',
    nodeId: 'Node ID',
    endpointId: 'EndPoint ID',
    processing: 'Processing...',
    result: 'Result:',
    pairingType: 'Please choose the pairing type:',
    onnetwork: 'ONNETWORK',
    bleWifi: 'BLE-WIFI',
    ...
    openCommissioningWindow: 'Open Commissioning Window with BCM',
    minInterval: 'Min Interval',
    maxInterval: 'Max Interval',
    subscribe: 'Subscribe',
    clearStatus: 'Clear Status',
    subscribeStatus: 'Subscribe Status',
    nodesManagement: 'Nodes Management',
    refreshStatus: 'Refresh Status',
    deleteStorageNode: 'Delete Storage Node',
    provisionedNodes: 'Provisioned Nodes',
    writeAcl: 'Write ACL',
    lightNodeAlias: 'Light Node Alias',
    lightNodeId: 'Light Node ID',
    switchNodeAlias: 'Switch Node Alias',
    switchNodeId: 'Switch Node ID',
    aclEndpointId: 'ACL EndPoint ID',
    writeBinding: 'Write Binding',
    lightEndpointId: 'Light EndPoint ID',
    switchEndpointId: 'Switch EndPoint ID',
    nodeSelection: 'Node Selection',
    mediaAppLaunch: 'Media App Launch',
    ...
    eevseEventTrigger: 'EEVSE Event Trigger',
    key: 'Key',
    startTriggerEvent: 'Start Trigger Event',
    clearTriggerEvent: 'Clear Trigger Event',
    triggerPluggedIn: 'Trigger PluggedIn',
    clearPluggedIn: 'Clear PluggedIn',
    triggerChargingDemand: 'Trigger Charging Demand',
    clearChargingDemand: 'Clear Charging Demand',
    eevseChargingEnable: 'EEVSE Charging Enable',
    minimumChargeCurrent: 'Minimum Charge Current',
    maximumChargeCurrent: 'Maximum Charge Current',
    enableCharging: 'Enable Charging',
    eevseWrite: 'EEVSE Write',
    userMaximumChargeCurrent: 'User Maximum Charge Current',
    writeUserMaximumChargeCurrent: 'Write User Maximum Charge Current',
    eevseDisable: 'EEVSE Disable',
    ...
    stepScanQR: 'Scan QR Code',
    stepConfigureDevice: 'Configure Device',
    stepStartPairing: 'Start Pairing',
    stepScanTitle: 'Step 1: Scan Device QR Code',
    stepConfigureTitle: 'Step 2: Configure Device',
    stepPairingTitle: 'Step 3: Start Pairing',
    scannedQRCode: 'Scanned QR Code',
    selectDeviceType: 'Select Device Type',
    deviceInformation: 'Device Information',
    deviceAlias: 'Device Alias',
    deviceAliasPlaceholder: 'Enter a friendly name for this device',
    deviceAliasValidation: 'Device Alias can only contain letters, numbers, and underscores',
    deviceAliasHint: 'Only letters, numbers, and underscores are allowed',
    backToScan: 'Back to Scan',
    nextConfigureConnection: 'Next: Configure Connection',
    ...
    wifiNetworkSSID: 'WiFi Network (SSID)',
    wifiNetworkPlaceholder: 'Enter WiFi network name',
    wifiPasswordPlaceholder: 'Enter WiFi password',
    threadDataset: 'Thread Dataset',
    threadDatasetPlaceholder: 'Enter Thread dataset or click Get Dataset',
    gettingDataset: 'Getting...',
    back: 'Back',
    pairing: 'Pairing...',
    startPairing: 'Start Pairing',
    configureThisDevice: 'Configure This Device',
    pairingSuccessful: 'Device "{alias}" paired successfully!',
    pairingFailed: 'Pairing failed',
    pairingError: 'An error occurred during pairing',
    getDatasetFailed: 'Failed to get Thread dataset',
    getDatasetError: 'Unexpected response format when getting Thread dataset',
