...
const translations = {
  ...
  wizard: {
    ...
    smartConnectTooltip: 'Combine all bands into one network name',
    mloNetwork: 'MLO Network',
    mloTooltip: 'Multi-Link Operation for faster speeds',
    psc: 'PSC',
    pscTooltip: 'Preferred Scanning Channels for 6GHz',
    pmf: 'PMF',
    pmfTooltip: 'Protected Management Frames for enhanced security',
