...
const translations = {
  ...
  guest: {
    ...
    dnsServersHint: 'Separate multiple DNS servers with commas, e.g. 192.168.1.1, 8.8.8.8 (max 4)',
    dnsServersInvalid: 'Invalid DNS server address. Please enter valid IPv4 addresses separated by commas.',
    dnsServersTooMany: 'Too many DNS servers. Maximum 4 DNS servers allowed.',
  ...
  wanManagement: {
    ...
    connectionTrigger: 'Connection Trigger',
  ...
  remoteSyslog: {
    ...
    sectionTitle: 'Remote Logging Destinations',
    description: 'Configure remote syslog servers to receive device logs. Each log type can forward to a different destination.',
    ...
    protocol: 'Protocol',
    status: 'Status',
    selectType: 'Select log type',
    typeConfigured: '(Configured)',
    enableRemoteLogging: 'Enable remote logging',
    errors: {
      typeRequired: 'Log type is required',
      addressRequired: 'Server address is required',
      invalidIp: 'Invalid IP address',
      invalidPort: 'Port must be between 1 and 65535',
      typeDuplicate: 'This log type already has a remote destination configured',
      destinationDuplicate: 'The destination {destination} is already in use by {type}. Please use a different IP:Port combination to avoid syslog-ng persist-name conflicts.',
      loadFailed: 'Failed to load configuration',
      saveFailed: 'Failed to save configuration',
      deleteFailed: 'Failed to delete configuration'
    },
    confirmDelete: 'Are you sure you want to delete the remote destination for {type}?',
    updateSuccess: 'Configuration updated successfully',
    deleteSuccess: '{type} remote destination deleted successfully'
  },
  operationMode: {
  ...
  basicWan: {
    title: 'Basic WAN Setup',
    interfaceManagement: 'WAN Interface Management',
    addInterface: 'Add Interface',
    ...
    iana: 'IANA',
    iapd: 'IAPD',
    pppv6SharesCredentials: 'PPPoEv6 uses the same username and password as IPv4 PPPoE settings.',
    ipv6Address: 'IPv6 Address',
    prefixLength: 'Prefix Length',
    ipv6DefaultRouter: 'IPv6 Default Router',
    ipv6DnsServers: 'IPv6 DNS Servers',
    save: 'Save',
    deleteConfirm: 'Are you sure you want to delete this interface?',
    applyFailed: 'Failed to apply WAN settings',
    vlanIdDuplicate: 'VLAN ID {id} is already used by {iface}.',
    detail: 'Detail',
    validationMtuRange: 'MTU must be between 576 and 1500.',
    validationVlanIdRange: 'VLAN ID must be between 1 and 4094.',
    validationVlanPriorityRange: 'VLAN Priority must be between 0 and 7.',
    validationRequired: '{field} is required.',
    validationMaxLength: '{field} must not exceed {max} characters.',
    validationInvalidIPv4: 'Invalid IPv4 address format.',
