...
const translations = {
  menu: {
    ...
    upnp: 'UPnP IGD',
    ddns: 'DDNS',
    storageService: 'Speicherdienst',
    management: 'Verwaltung',
    reboot: 'Neustart',
    account: 'Kontoverwaltung',
    language: 'Sprache',
    ntp: 'NTP',
    remoteSyslog: 'Remote-Protokollierung',
    tr069: 'TR-069',
    tr369: 'TR-369',
  ...
  wanCht: {
    ...
    subnetMask: 'Subnetzmaske',
    ipv4PrimaryDNS: 'Primärer IPv4-DNS-Server',
    ipv4SecondaryDNS: 'Sekundärer IPv4-DNS-Server',
    macAddress: 'MAC-Adresse',
    ipv6Address: 'IPv6-Adresse',
    ipv6Gateway: 'IPv6-Gateway',
    ipv6Prefix: 'IPv6-Präfix',
    ipv6PrimaryDNS: 'Primärer IPv6-DNS-Server',
    ipv6SecondaryDNS: 'Sekundärer IPv6-DNS-Server',
    ipv4ConnectionStatus: 'IPv4-Verbindungsstatus',
  ...
  lanCht: {
    title: 'LAN-Verbindungsstatus',
    connectionStatus: 'LAN-Verbindungsstatus',
    interface: 'Schnittstelle',
    lanInterface: 'LAN',
    protocol: 'Protokoll',
  ...
  lcm: {
    ...
    titleConfiguration: 'LCM-Konfiguration',
    ...
    vendor: 'Hersteller',
    version: 'Version',
    executionEnvironment: 'Ausführungsumgebung',
    addEE: 'EE hinzufügen',
    addExecEnv: 'Ausführungsumgebung hinzufügen',
    editExecEnv: 'Ausführungsumgebung bearbeiten',
    no: 'Nr.',
    enabled: 'Aktiviert',
    action: 'Aktion',
    resourceConfiguration: 'Ressourcenkonfiguration',
    cpuPercent: 'CPU-Auslastung (%)',
    cpuHint: 'Bereich: 1–100, Standardwert: 100',
    memorySize: 'Speichergröße',
    memHint: 'Bereich: 1–{max} MiB, Standardwert: 1',
    diskSpace: 'Speicherplatz',
    diskHint: 'Bereich: 1–{max} MiB, Standardwert: 1',
    nameRequired: 'Name ist erforderlich',
    nameExists: 'Name ist bereits vorhanden',
    cpuRange: 'CPU muss zwischen 1 und 100 liegen',
    ...
    installedEE: 'Installierte EE',
    appRegistry: 'App-Registry',
    urlRequired: 'URL ist erforderlich',
    urlFormatError: 'Die URL muss mit docker:// beginnen',
    urlPlaceholder: 'docker://<server>/<app>:<tag>',
    uuidRequired: 'UUID ist erforderlich',
    uuidFormatError: 'UUID-Format ist ungültig (xxxxxxxx-xxxx-5xxx-Nxxx-xxxxxxxxxxxx)',
    uuidPlaceholder: 'xxxxxxxx-xxxx-5xxx-Nxxx-xxxxxxxxxxxx',
    username: 'Benutzername',
    usernameRequired: 'Benutzername ist erforderlich',
    password: 'Passwort',
    passwordRequired: 'Passwort ist erforderlich',
    eeToInstalled: 'Zu installierende EE',
    installedEERequired: '„Zu installierende EE“ ist erforderlich',
    runtimeConfiguration: 'Laufzeitkonfiguration',
    privileged: 'Privilegierter Modus',
    network: 'Netzwerk',
    shareParentNetwork: 'Parent-Netzwerk teilen',
    portForwarding: 'Portweiterleitung',
    portForwardingRules: 'Regeln für Portweiterleitung',
    interface: 'Schnittstelle',
    protocol: 'Protokoll',
    externalPort: 'Externer Port',
    internalPort: 'Interner Port',
    hostObject: 'Host-Objekt',
    source: 'Quelle',
    destination: 'Ziel',
    type: 'Typ',
    ...
    enable: 'Aktivieren',
    disable: 'Deaktivieren',
    maximumRetryCount: 'Maximale Anzahl von Wiederholversuchen',
    readonly: 'Schreibgeschützt',
    executionUnit: 'Ausführungseinheit',
    uptime: 'Betriebszeit',
    start: 'Starten',
    stop: 'Stoppen',
    systemResourceUsage: 'Systemressourcenauslastung',
    availableMemory: 'Verfügbarer Speicher',
    availableDiskSpace: 'Verfügbarer Speicherplatz',
    state: 'Zustand',
    pid: 'PID',
    ipAddress: 'IP-Adresse',
    rootUid: 'Root-UID'
  ...
  wireless: {
    ...
    backhaulSsidConfig: 'Backhaul-SSID-Konfiguration',
    ...
    mloModeDisabledWithGroups: 'MLO ist für Gruppen aktiviert: {groups} – Modus kann nicht geändert werden.',
    ...
    securityNone6GWarning: '6-GHz-AP wird deaktiviert, wenn der Sicherheitsmodus eines AP auf „None" eingestellt ist.',
  ...
  guest: {
    ...
    dnsServersTooMany: 'Zu viele DNS-Server. Maximal 4 DNS-Server erlaubt.',
  ...
  wanManagement: {
    ...
    connectionTrigger: 'Verbindungsauslöser',
  ...
  lanBasic: {
    ...
    ipv4Protocol: 'IPv4-Protokoll',
    protocolDhcp: 'DHCP',
    protocolStatic: 'Statisch',
    protocolAutoConfigured: 'Automatisch konfiguriert',
    protocolDhcpv6: 'DHCPv6',
    ipAddress: 'IP-Adresse',
    ipv4Address: 'IPv4-Adresse',
    subnetMask: 'Subnetzmaske',
    ipv6Enable: 'IPv6 aktivieren',
    ulaEnable: 'ULA aktivieren',
    ipv6Protocol: 'IPv6-Protokoll',
    ipv6Address: 'IPv6-Adresse',
    ipv6Prefix: 'IPv6-Präfix',
    ...
    applyingDhcpAcl: 'DHCP ACL-Einstellungen werden angewendet...',
    fetchDhcpAclFailed: 'DHCP ACL-Einstellungen konnten nicht abgerufen werden',
    updateDhcpAclFailed: 'DHCP ACL-Einstellungen konnten nicht aktualisiert werden',
  ...
  dmz: {
    ...
    ipAddress: 'IP-Adresse',
    ipAddressHint: 'Geben Sie die IP-Adresse des DMZ-Hosts ein',
    ...
    ipRequired: 'DMZ-IP-Adresse ist erforderlich, wenn DMZ aktiviert ist.',
    invalidIpFormat: 'Ungültiges IP-Adressformat. Bitte geben Sie eine gültige IPv4-Adresse ein (z. B. 192.168.1.100).',
    ipNotInLanSubnet: 'Die DMZ-IP-Adresse muss im LAN-Subnetz-Bereich liegen.',
    selectDevice: 'Aus verbundenen Geräten wählen',
  ...
  remoteSyslog: {
    ...
    sectionTitle: 'Remote-Protokollierungsziele',
    description: 'Konfigurieren Sie Remote-Syslog-Server zum Empfangen von Geräteprotokollen. Jeder Protokolltyp kann an ein anderes Ziel weitergeleitet werden.',
    ...
    protocol: 'Protokoll',
    status: 'Status',
    selectType: 'Protokolltyp auswählen',
    typeConfigured: '(Konfiguriert)',
    enableRemoteLogging: 'Remote-Protokollierung aktivieren',
    errors: {
      typeRequired: 'Protokolltyp ist erforderlich',
      addressRequired: 'Serveradresse ist erforderlich',
      invalidIp: 'Ungültige IP-Adresse',
      invalidPort: 'Port muss zwischen 1 und 65535 liegen',
      typeDuplicate: 'Dieser Protokolltyp hat bereits ein Remote-Ziel konfiguriert',
      destinationDuplicate: 'Das Ziel {destination} wird bereits von {type} verwendet. Bitte verwenden Sie eine andere IP:Port-Kombination, um syslog-ng persist-name-Konflikte zu vermeiden.',
      loadFailed: 'Fehler beim Laden der Konfiguration',
      saveFailed: 'Fehler beim Speichern der Konfiguration',
      deleteFailed: 'Fehler beim Löschen der Konfiguration'
    },
    confirmDelete: 'Sind Sie sicher, dass Sie das Remote-Ziel für {type} löschen möchten?',
    updateSuccess: 'Konfiguration erfolgreich aktualisiert',
    deleteSuccess: '{type} Remote-Ziel erfolgreich gelöscht'
  },
  operationMode: {
  ...
  device: {
    ...
    sendBootstrap: 'Bootstrap an ACS-Server senden',
    logCount: 'Anzahl',
    logMaxEntries: 'Max. Einträge',
    logServerTime: 'Serverzeit',
    logTimestamp: 'Zeitstempel',
    logEventType: 'Ereignistyp',
    logDetail: 'Detail',
    alias: 'Alias',
    ...
    duplicateEndpointId: 'Die EndpointID des Controllers ist bereits vorhanden. Bitte verwenden Sie einen anderen Wert.',
    duplicateControllerTopic: 'Das Controller-Topic ist bereits vorhanden. Bitte verwenden Sie einen anderen Wert.'
  },
  tr471: {
    title: 'TR-471-Speedtest',
    connection_server: 'Server',
    connection_port: 'Port',
    connection_mtu: 'MTU',
    connection_dscp: 'DSCP',
    connection_protocolVersion: 'Protokollversion',
    connection_networkInterface: 'Netzwerkschnittstelle',
    connection_algorithm: 'Algorithmus',
    connection_udpPayloadContent: 'UDP-Nutzlastinhalt',
    connection_ethernetPriority: 'Ethernet-Priorität',
    connection_authenticationEnabled: 'Authentifizierung aktiviert',
    connection_authenticationCode: 'Authentifizierungscode',
    connection_interfaceRateIncluded: 'Lokale Schnittstellengeschwindigkeit einbeziehen',
    connection_jumboFramesPermitted: 'Jumbo Frames zulässig',
    connection_ipdvEnable: 'IPDV aktivieren',
    advanced_toggleShow: 'Erweiterte Konfiguration anzeigen',
    advanced_toggleHide: 'Erweiterte Konfiguration ausblenden',
    advanced_maximumTestBandwidth: 'Maximale Testbandbreite',
    advanced_startSendingRate: 'Start-Sendegeschwindigkeit',
    advanced_startSendingRateIndex: 'Index der Start-Sendegeschwindigkeit',
    advanced_numberTestSubIntervals: 'Anzahl der Test-Teilintervalle',
    advanced_numberFirstModeTestSubIntervals: 'Anzahl der Test-Teilintervalle im ersten Modus',
    advanced_testSubInterval: 'Test-Teilintervall',
    advanced_statusFeedbackInterval: 'Status-Rückmeldeintervall',
    advanced_retryThresh: 'Wiederholschwelle',
    advanced_testType: 'Testtyp',
    advanced_seqErrThresh: 'Schwelle für Sequenzfehler',
    advanced_reordDupIgnoreEnable: 'Reorder/Duplikate ignorieren aktivieren',
    advanced_lowerThresh: 'Untere Schwelle',
    advanced_upperThresh: 'Obere Schwelle',
    advanced_slowAdjThresh: 'Schwelle für langsame Anpassung',
    advanced_highSpeedDelta: 'High-Speed-Delta',
    advanced_flowCount: 'Anzahl der Flows',
    advanced_maximumFlows: 'Maximale Anzahl der Flows',
    test_sectionTitle: 'Geschwindigkeitstest-Typ',
    test_upload: 'Upload',
    test_download: 'Download',
    test_run: 'Geschwindigkeitstest starten',
    test_running: 'Test wird ausgeführt…',
    test_canNotRun: 'Wählen Sie mindestens einen Testtyp aus',
    results_title: 'Ergebnisübersicht',
    results_uploadTitle: 'Upload-Ergebnis',
    results_downloadTitle: 'Download-Ergebnis',
    results_label_ipLayerCapacity: 'IP-Layer-Kapazität',
    results_label_lossRatio: 'Verlustquote',
    results_label_rttRange: 'RTT-Bereich',
    results_label_pdvRange: 'PDV-Bereich',
    results_chart_ipLayerCapacity: 'IP-Layer-Kapazität',
    results_chart_roundTripTime: 'Round-Trip-Time (RTT)',
    results_chart_jitter: 'Jitter',
    results_chart_loss: 'Verlust',
    results_state_none: 'Keine',
    results_state_requested: 'Angefordert',
  ...
  wizard: {
    ...
    mloTooltip: 'Multi-Link Operation (MLO) ermöglicht es Wi-Fi-7-Geräten, gleichzeitig über die 2,4-GHz-, 5-GHz- und 6-GHz-Bänder zu verbinden und bietet so höhere Geschwindigkeiten, niedrigere Latenzen und mehr Zuverlässigkeit – ideal für VR/AR, Gaming, Remote-Arbeit und Cloud Computing.',
    psc: 'PSC',
    ...
    onboardingFailedTitle: 'Einrichtung fehlgeschlagen',
    onboardingStartFailed: 'Die Einrichtung konnte nicht gestartet werden. Bitte versuchen Sie es erneut.',
    onboardingFailed: 'Das Onboarding ist fehlgeschlagen. Bitte überprüfen Sie die Verbindung und versuchen Sie es erneut.',
    ethernetConnectionFailed: 'Die Ethernet-Verbindung ist fehlgeschlagen. Bitte überprüfen Sie das Kabel und versuchen Sie es erneut.',
    onboardingTimeout: 'Die Einrichtung ist abgelaufen. Bitte überprüfen Sie die Verbindung und versuchen Sie es erneut.',
    backToSetup: 'Zurück zur Einrichtung',
    applyingTitle: 'Einstellungen werden angewendet...',
    applyingMessage: 'Ihre Einstellungen werden angewendet.',
    ...
    acceptTermsCheckbox: 'Ich habe die Lizenzbedingungen für die Nutzung dieser Software gelesen und akzeptiert',
    ssid: 'SSID',
    ...
    passwordPlaceholderWifi: '8–63 Zeichen, Buchstaben und Zahlen',
    passwordHelpText: 'Verwenden Sie 8–63 Zeichen mit einer Kombination aus Buchstaben und Zahlen.',
  ...
  mcl: {
    title: 'MCL',
    mgmtServices: 'Management-Dienste',
    trustDomain: 'Vertrauensdomäne',
    wanInterfacesForAccessingServices: 'Für den Zugriff auf Dienste verwendete WAN-Schnittstellen:',
    anyWan: 'Beliebiges WAN',
    multipleWans: 'Mehrere WANs',
    service: 'Dienste',
    lan: 'LAN',
    wan: 'WAN',
    port: 'Port',
    ipAddress: 'IP-Adresse',
    ipAddresses: 'IP-Adressen',
    addTrustDomain: 'Vertrauensdomäne hinzufügen',
    trustDomainPlaceholder: 'z. B. 192.168.1.0/24',
    cidrHint: 'Format: CIDR <IP Address>/<Prefix Length>',
    saveSuccess: 'MCL-Einstellungen erfolgreich gespeichert',
    errorFetch: 'MCL-Einstellungen konnten nicht geladen werden',
    errorSave: 'MCL-Einstellungen konnten nicht gespeichert werden',
    errorSelectWanInterface: 'Wählen Sie im Modus „Mehrere WANs“ mindestens eine WAN-Schnittstelle aus',
    errorTrustDomainRequired: 'IP-Adresse ist erforderlich',
    errorTrustDomainFormat: 'Ungültiges CIDR-Format. Verwenden Sie <IP Address>/<Prefix Length>',
    errorTrustDomainDuplicate: 'Diese Vertrauensdomäne existiert bereits',
    addTrustDomainSuccess: 'Vertrauensdomäne erfolgreich hinzugefügt',
    deleteTrustDomainSuccess: 'Vertrauensdomäne erfolgreich gelöscht',
    confirmDeleteTrustDomainTitle: 'Vertrauensdomäne löschen',
    confirmDeleteTrustDomainMessage: 'Möchten Sie "{cidr}" wirklich löschen?',
  },
  nat: {
  ...
  portForwarding: {
    ...
    internalPortRange: 'Interner Port',
    internalIPAddress: 'Interne IP-Adresse',
    active: 'Aktiv',
  ...
  basicWan: {
    title: 'Grundlegende WAN-Einrichtung',
    interfaceManagement: 'WAN-Schnittstellenverwaltung',
    addInterface: 'Schnittstelle hinzufügen',
    editInterface: 'Schnittstelle bearbeiten',
    interface: 'Schnittstelle',
    ipv4Mode: 'IPv4-Modus',
    ipv6Mode: 'IPv6-Modus',
    vlanType: 'VLAN-Typ',
    ...
    vlanPriority: 'VLAN-Priorität',
    ipv4Settings: 'IPv4-Einstellungen',
    ipv4Enable: 'IPv4 aktivieren',
    hostName: 'Hostname',
    ...
    iana: 'IANA',
    iapd: 'IAPD',
    pppv6SharesCredentials: 'PPPoEv6 verwendet denselben Benutzernamen und dasselbe Passwort wie die IPv4-PPPoE-Einstellungen.',
    ipv6Address: 'IPv6-Adresse',
    prefixLength: 'Präfixlänge',
    ipv6DefaultRouter: 'IPv6-Standard-Router',
  ...
  basicWanCht: {
    ...
    enable: 'Aktivieren',
    enableWarning: 'Wenn diese Option aktiviert ist, werden alle anderen Felder zur Konfiguration angezeigt.',
    ipv4Protocol: 'IPv4-Protokoll',
    protocolReadOnly: 'Dieses Feld ist schreibgeschützt.',
    username: 'Benutzername',
    password: 'Passwort',
    fieldNotEmpty: 'Dieses Feld darf nicht leer sein.',
    serviceName: 'Dienstname (optional)',
    connectionType: 'Verbindungstyp',
    alwaysConnected: 'Stets verbunden',
    triggerByTraffic: 'Auto – durch Datenverkehr auslösen',
    connectTrigger: 'Verbindungsauslöser',
    alwaysOn: 'AlwaysOn',
    onDemand: 'OnDemand',
    idleTime: 'Leerlaufzeit',
    idleTimeModifiable: 'Dieses Feld kann nur geändert werden, wenn der Verbindungstyp „Auto – durch Datenverkehr auslösen“ ist.',
    mtu: 'MTU ({min}–{max})',
    ...
    primaryDNS: 'Primärer DNS',
    secondaryDNS: 'Sekundärer DNS',
    dnsManualModifiable: 'Dieses Feld kann nur geändert werden, wenn „DNS-IP-Adresse“ auf „Manuell“ eingestellt ist.',
    natFunction: 'NAT-Funktion',
    igmpProxy: 'IGMP-Proxy',
    vlan: 'VLAN',
    priorityBit: 'Prioritätsbit',
    vlanId: 'VLAN-ID',
  ...
  routing: {
    ...
    dnsRoute: 'DNS-Route',
    policyRoute: 'Policy-Based Routing',
    rip: 'RIP',
    staticRouteDescription: 'Sie können statische Routen konfigurieren, um zu steuern, wie der Datenverkehr zwischen Ihrem lokalen Netzwerk und anderen Netzwerken weitergeleitet wird. Statische Routen helfen dabei, mehrere Subnetze zu verbinden, Pfade zu optimieren und die Gesamteffizienz des Netzwerks zu verbessern.',
    dnsRouteDescription: 'Konfigurieren Sie DNS-Routingregeln, um die Weiterleitung von DNS-Anfragen basierend auf Domänenmustern zu steuern.',
    addStaticRoute: 'Statische Route hinzufügen',
    editStaticRoute: 'Statische Route bearbeiten',
    status: 'Status',
    name: 'Name',
    destinationIp: 'Ziel-IP',
    subnetMaskPrefixLength: 'Subnetzmaske/Präfixlänge',
    gateway: 'Gateway',
    interface: 'Schnittstelle',
    action: 'Aktion',
    noStaticRoutes: 'Keine statischen Routen konfiguriert',
    confirmDelete: 'Möchten Sie diese statische Route wirklich löschen?',
    enable: 'Aktivieren',
    routeName: 'Routenname',
    routeNamePlaceholder: 'Routennamen eingeben',
    ipType: 'IP-Typ',
    destinationIpAddress: 'Ziel-IP-Adresse',
    subnetMask: 'Subnetzmaske',
    prefixLength: 'Präfixlänge',
    useGatewayIpAddress: 'Gateway-IP-Adresse verwenden',
    gatewayIpAddress: 'Gateway-IP-Adresse',
    useInterface: 'Schnittstelle verwenden',
    note: 'Hinweis',
    gatewayIpNote: 'Die Gateway-IP-Adresse muss im Adressbereich der ausgewählten Schnittstelle liegen.',
    routeNameRequired: 'Routenname ist erforderlich',
    destinationIpRequired: 'Ziel-IP-Adresse ist erforderlich',
    subnetMaskRequired: 'Subnetzmaske ist erforderlich',
    invalidIPv4: 'Ungültiges IPv4-Adressformat',
    ...
    addDnsRoute: 'DNS-Route hinzufügen',
    editDnsRoute: 'DNS-Route bearbeiten',
    noDnsRoutes: 'Keine DNS-Routen konfiguriert',
    domainName: 'Domainname',
    wanInterface: 'WAN-Schnittstelle',
    domainNamePlaceholder: 'Domainname eingeben, z. B. ims1.cht.com.tw',
    selectWanInterface: 'WAN-Schnittstelle auswählen',
    resolverIpv4: 'DNS-Server IPv4 (optional)',
    resolverIpv4Placeholder: 'Zum Beispiel 8.8.8.8',
    resolverIpv6: 'DNS-Server IPv6 (optional)',
    resolverIpv6Placeholder: 'Zum Beispiel 2001:4860:4860::8888',
    domainNameRequired: 'Domainname ist erforderlich',
    domainNameInvalid: 'Ungültiges Domainnamenformat',
    duplicateDomainName: 'Domainname existiert bereits. Bitte verwenden Sie eine andere Domain',
    wanInterfaceRequired: 'WAN-Schnittstelle ist erforderlich',
    invalidResolverIPv4: 'Ungültige DNS-Server-IPv4-Adresse',
    invalidResolverIPv6: 'Ungültige DNS-Server-IPv6-Adresse',
    maxDnsRoutesNote: 'Hinweis: Es können maximal 20 Einträge hinzugefügt werden.',
    maxDnsRoutesReached: 'Es sind maximal 20 DNS-Routen zulässig',
