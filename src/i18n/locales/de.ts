...
const translations = {
  ...
  remoteSyslog: {
    title: 'Remote-Syslog-Konfiguration',
    description: 'Konfigurieren Sie Remote-Syslog-Server, um Geräteprotokolle von Systemnachrichten, WiFi und hostapd zu empfangen',
    systemMessages: 'Systemnachrichten',
    systemMessagesDesc: 'Allgemeine Systemprotokolle (/var/log/messages)',
    wifiLogs: 'WiFi-Protokolle',
    wifiLogsDesc: 'WiFi-bezogene Protokolle (/var/log/messages_wifi)',
    hostapdLogs: 'Hostapd-Protokolle',
    hostapdLogsDesc: 'Hostapd-Daemon-Protokolle (/var/log/hostapd)',
    enableRemoteLogging: 'Remote-Protokollierung aktivieren',
    serverAddress: 'Serveradresse',
    serverAddressPlaceholder: 'IP-Adresse oder Hostname',
    port: 'Port',
    portPlaceholder: '514',
    protocol: 'Protokoll',
    status: 'Status',
    ...
    statusError: 'Fehler',
    invalidIpAddress: 'Ungültige IP-Adresse oder Hostname',
    invalidPort: 'Port muss zwischen 1 und 65535 liegen',
    addressRequired: 'Serveradresse ist erforderlich, wenn aktiviert',
    validationFailed: 'Bitte beheben Sie die Validierungsfehler vor dem Absenden',
    updateSuccess: 'Konfiguration erfolgreich aktualisiert',
    updateFailed: 'Konfigurationsaktualisierung fehlgeschlagen',
