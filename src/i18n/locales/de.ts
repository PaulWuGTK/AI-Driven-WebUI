...
export default {
  ...
  wizard: {
    ...
    smartConnectTooltip: 'Alle Bänder unter einem Netzwerknamen zusammenführen',
    mloNetwork: 'MLO-Netzwerk',
    mloTooltip: 'Multi-Link Operation für höhere Geschwindigkeiten',
    psc: 'PSC',
    pscTooltip: 'Bevorzugte Scan-Kanäle für 6 GHz',
    pmf: 'PMF',
    pmfTooltip: 'Protected Management Frames für erhöhte Sicherheit',
