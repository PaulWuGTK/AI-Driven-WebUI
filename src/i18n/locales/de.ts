...
export default {
  ...
  matter: {
    ...
    stepScanQR: 'QR-Code scannen',
    stepConfigureDevice: 'Gerät konfigurieren',
    stepStartPairing: 'Kopplung starten',
    stepScanTitle: 'Schritt 1: Geräte-QR-Code scannen',
    stepConfigureTitle: 'Schritt 2: Gerät konfigurieren',
    stepPairingTitle: 'Schritt 3: Kopplung starten',
    scannedQRCode: 'Gescannter QR-Code',
    selectDeviceType: 'Gerätetyp auswählen',
    deviceInformation: 'Geräteinformationen',
    deviceAlias: 'Gerätealias',
    deviceAliasPlaceholder: 'Geben Sie einen benutzerfreundlichen Namen für dieses Gerät ein',
    deviceAliasValidation: 'Gerätealias darf nur Buchstaben, Zahlen und Unterstriche enthalten',
    deviceAliasHint: 'Nur Buchstaben, Zahlen und Unterstriche sind erlaubt',
    backToScan: 'Zurück zum Scannen',
    nextConfigureConnection: 'Weiter: Verbindung konfigurieren',
    deviceSummary: 'Geräteübersicht',
    connectionConfiguration: 'Verbindungskonfiguration',
    wifiConnection: 'WiFi-Verbindung',
    threadNetwork: 'Thread-Netzwerk',
    wifiNetworkSSID: 'WiFi-Netzwerk (SSID)',
    wifiNetworkPlaceholder: 'WiFi-Netzwerkname eingeben',
    wifiPasswordPlaceholder: 'WiFi-Passwort eingeben',
    threadDataset: 'Thread-Dataset',
    threadDatasetPlaceholder: 'Thread-Dataset eingeben oder auf Dataset abrufen klicken',
    gettingDataset: 'Abrufen...',
    back: 'Zurück',
    pairing: 'Kopplung...',
    startPairing: 'Kopplung starten',
    configureThisDevice: 'Dieses Gerät konfigurieren',
    pairingSuccessful: 'Gerät "{alias}" erfolgreich gekoppelt!',
    pairingFailed: 'Kopplung fehlgeschlagen',
    pairingError: 'Ein Fehler ist bei der Kopplung aufgetreten',
    getDatasetFailed: 'Thread-Dataset konnte nicht abgerufen werden',
    getDatasetError: 'Unerwartetes Antwortformat beim Abrufen des Thread-Datasets',
    smartLight: 'Intelligente Beleuchtung',
    smartSwitch: 'Intelligenter Schalter',
    sensor: 'Sensor',
    smartOutlet: 'Intelligente Steckdose',
