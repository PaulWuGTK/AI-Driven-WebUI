...
const translations = {
  ...
  wireless: {
    ...
    securityNone6GWarning: '當任何 AP 的安全模式設定為 None 時，6GHz AP 將會被停用。',
  ...
  remoteSyslog: {
    title: '遠端 Syslog 設定',
    description: '設定遠端 syslog 伺服器以接收來自系統訊息、WiFi 和 hostapd 的裝置記錄',
    systemMessages: '系統訊息',
    systemMessagesDesc: '一般系統記錄 (/var/log/messages)',
    wifiLogs: 'WiFi 記錄',
    wifiLogsDesc: 'WiFi 相關記錄 (/var/log/messages_wifi)',
    hostapdLogs: 'Hostapd 記錄',
    hostapdLogsDesc: 'Hostapd 服務記錄 (/var/log/hostapd)',
    enableRemoteLogging: '啟用遠端記錄',
    serverAddress: '伺服器位址',
    serverAddressPlaceholder: 'IP 位址或主機名稱',
    port: '埠號',
    portPlaceholder: '514',
    protocol: '協定',
    status: '狀態',
    ...
    statusEnabled: '已啟用',
    statusError: '錯誤',
    invalidIpAddress: '無效的 IP 位址或主機名稱',
    invalidPort: '埠號必須介於 1 到 65535 之間',
    addressRequired: '啟用時必須輸入伺服器位址',
    validationFailed: '請修正驗證錯誤後再送出',
  ...
  basicWan: {
    ...
    iana: 'IANA',
    iapd: 'IAPD',
    pppv6SharesCredentials: 'PPPoEv6 使用與 IPv4 PPPoE 相同的帳號密碼設定。',
    ipv6Address: 'IPv6 位址',
    prefixLength: '前綴長度',
    ipv6DefaultRouter: 'IPv6 預設路由器',
  ...
  routing: {
    ...
    gatewayIpRequired: '閘道 IP 位址為必填項',
